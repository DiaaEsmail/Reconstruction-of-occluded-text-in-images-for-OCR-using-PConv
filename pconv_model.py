...
class PConvUnet(object):
    ...
    def __init__(self, img_rows=512, img_cols=512, vgg_weights="imagenet", inference_only=False, net_name='default', gpus=1, vgg_device=None):
        ...
        Args:
            ...
            inference_only (bool): initialize BatchNormalizationN layers for inference.
        ...
        '''The VGG16 model was chosen for feature extraction. The VGG16 model in PyTorch was trained with the following image pre-processing:
           ...
           The same pre-processing scheme was used in the paper. The VGG16 model in Keras comes with weights ported from the original Caffe implementation
           and expects another image pre-processing:
    ...
    def load(self, filepath, train_bn=True, lr=0.002):
