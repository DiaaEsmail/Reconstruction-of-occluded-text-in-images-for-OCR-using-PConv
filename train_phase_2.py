...
output_dir = './phase_2_coco_2017_output/test_samples'
try:
...
def plot_callback(model):
    ...
    output_plot = './phase_2_coco_2017_output_plot/plot_samples'
    try:
...
model.load("coco_phase1coco_2017_phase_1_weights.43-1.08.h5",train_bn=False,lr=0.00005)
...
model.fit_generator(
    ...
    callbacks=[
        ...
        ModelCheckpoint(
            FOLDER + '_weights.{epoch:02d}-{loss:.2f}.h5',
            monitor='val_loss',
            save_best_only=True,
