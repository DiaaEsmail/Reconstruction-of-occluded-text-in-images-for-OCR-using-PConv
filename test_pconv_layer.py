...
'''
   Note it looks exactly likt it's supposed to be,
   the further down we do in the network, the less significant the masking gets.'''
...
#plt.show()
plt.savefig('masks_from_PConv_test')
